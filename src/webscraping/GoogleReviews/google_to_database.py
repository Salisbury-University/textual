...
# Program Name: google_to_database.py
# Date: 4/11/2023
...
def get_client():
    ...
    client = MongoClient("mongodb://10.251.12.85:30000", username=username, password=password)
...
def pushReviews(input_arr):
    ...
    goodreads_collection = database.GoogleReviews
    ...
    if (database.command("dbstats")["fsUsedSize"] < 128481273344):
        ...
        for i in range(0, len(input_arr)):
            ...
            try:
                ...
                # review_dict["text"] = review_dict.pop("text")
                goodreads_collection.insert_one(review_dict)
            except:
